...
#$ -l h_rt=40:00:00
#$ -l h_vmem=6G
#$ -N GATK_IllPCRFree_haplotrigger2.6
#$ -pe thread 1
#$ -t 18-21
...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R /scratch/justin.zook/references/human_g1k_v37.fasta -I /scratch/justin.zook/NA12878/IllPCRFree/ERR09157x_dedup_realign.sorted.bam \
	...
	-A AlleleBalance -A BaseQualityRankSumTest -A Coverage -A FisherStrand -A HaplotypeScore -A HomopolymerRun -A MappingQualityRankSumTest -A MappingQualityZero -A QualByDepth -A ClippingRankSumTest -A RMSMappingQuality \
	 --minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 200 -o /scratch/justin.zook/NA12878/IllPCRFree/ERR09157x_dedup_realign_haplotrigger2.6_130719_"$LINE1".vcf
