...
#$ -l h_rt=90:00:00
#$ -l h_vmem=5G
#$ -N GATK_PlatGen_haplotrigger2.5
#$ -pe thread 1
#$ -t 2-21
...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R /scratch/justin.zook/references/human_g1k_v37.fasta  \
	...
	--minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 200 -o /scratch/justin.zook/NA12878/PlatGen/PlatGen_haplotrigger2.5_130526_"$LINE1".vcf
