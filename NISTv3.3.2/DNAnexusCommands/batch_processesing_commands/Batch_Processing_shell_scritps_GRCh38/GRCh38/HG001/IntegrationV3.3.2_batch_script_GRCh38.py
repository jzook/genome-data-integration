...
cstable= "161004_HG001_Callset_tables_CG_Ilmn_Ion_10X_Solid5500_for_GRCh38_v3.3.1_and_v3.3.2/"
...
for i in range(15):  
	...
	out.write("dx run -y GIAB:/Workflow/nist-integration-v3.3.2-anyref "+
		...
		"-ibeds=/"+HG+"/GRCh38/Illumina/Integration_prepare_GATKHC_v.3.3.2/" + HG + "_" + str(chr) + "_GRCh38_novoalign_150bp300x_GATKHC_gvcf_callable.bed " +
