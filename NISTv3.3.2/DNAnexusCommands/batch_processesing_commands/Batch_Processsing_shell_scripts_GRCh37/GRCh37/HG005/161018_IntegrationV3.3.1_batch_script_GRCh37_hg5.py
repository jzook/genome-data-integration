...
out = open("161018_integration_hg5_v3.3.1.sh", "w") 

#Set all of these values as appropriate for current integration
int="v.3.3.1"                              #Integration version
HG="HG005" 								#genome number
intdate= "161018" 						#date integration is being run, yymmdd
CG="GS000037265" 						#identifier for Complete Genomics dataset
ion="20141120.NA24631" 				    #identifier for Ion dataset
...
cstable= "-icallsettable=/callset_tables/161018_HG005_Callset_tables_CG_Illmn_10X_Ion_Solid_for_GRCh37_v3.3.1/HG005_RM8393_Datasets_CG_Illumina_Ion_10X_Solid_Files_GRCh37_"
...
ifiltbed1= "-ifiltbeds=/HG005/GRCh37/HG005_FB_GATKHC_CG_allsvs_merged.bed"
...
for i in range(15):  
	...
	out.write("dx run -y GIAB:/Workflow/nist-integration-v3.3.1-anyref "+
		...
		"-ivcfs=/"+HG+"/GRCh37/Illumina/Illumina_hs37d5_250x250/GATKHC_output/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn250x250_300x_GATKHC.vcf.gz " +
		"-ivcfs=/"+HG+"/GRCh37/Illumina/Illumina_hs37d5_250x250/FreeBayes_output/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn250x250_300x_FB.vcf.gz " +
		...
		"-ivcfs=/"+HG+"/GRCh37/SOLID/SE75bp/GATKHC_output/"+ HG + "_" + str(chr) + "_hg19_solid5500_SE75bp_GATKHC.vcf.gz "+
		...
		"-ibeds=/"+HG+"/GRCh37/Illumina/Illumina_hs37d5_250x250/Integration_prepare_GATKHC_v.3.3.1/" + HG + "_" + str(chr) +"_hs37d5_novoalign_Ilmn250x250_300x_GATKHC_gvcf_callable.bed " +
