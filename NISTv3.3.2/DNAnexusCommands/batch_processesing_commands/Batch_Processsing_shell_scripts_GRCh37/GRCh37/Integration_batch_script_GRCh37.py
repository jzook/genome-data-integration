...
out = open("integration_script_test.sh", "w") 

#Set all of these values as appropriate for current integration
int="v3.3"                              #Integration version
HG="HG004" 								#genome number
intdate= "160919" 						#date integration is being run, yymmdd
...
cstable= "-icallsettable=/callset_tables/160831_HG004_Callset_tables_CG_Illmn_10X_Ion_for_V3.3/HG004_RM8392_Datasets_Ilmn_CG_10X_Ion_files_"
...
ifiltbed1= "-ifiltbeds=/HG004/HG002_HG003_HG004_allsvs_merged.bed"
ifiltbed2= "-ifiltbeds=/filtbeds/AllRepeats_lt51bp_gt95identity_merged_slop5.bed.gz"
ifiltbed3= "-ifiltbeds=/filtbeds/AllRepeats_51to200bp_gt95identity_merged_slop5.bed.gz"
ifiltbed4= "-ifiltbeds=/filtbeds/AllRepeats_gt200bp_gt95identity_merged_sort.bed"
ifiltbed5= "-ifiltbeds=/filtbeds/hg19_self_chain_split_withalts_gt10k.bed.gz"
ifiltbed6= "-ifiltbeds=/filtbeds/SimpleRepeat_imperfecthomopolgt10_slop5.bed.gz"
ifiltbed7= "-ifiltbeds=/filtbeds/superdupsmerged_all_sort.bed"
ifiltbed8= "-ifiltbeds=/filtbeds/mm-2-merged.bed"
...
for i in range(15):  
	...
	out.write("dx run -y GIAB:/Workflow/nist-integration-"+int+" "+
		...
		"-ibeds=/"+HG+"/GRCh37/Illumina/Illumina_hs37d5_150x150/Integration_prepare_GATKHC_"+int+"/"+HG+"_"+str(chr) +"_hs37d5_novoalign_Ilmn150bp300X_GATKHC_gvcf_callable.bed " +
		...
		"-ichrom=" + str(chr) + " " + "-iprefix="+ HG + "_GIAB_highconf_"+ callsets + "_" + str(chr) + "_" + int + " " + "--destination=/" + HG + "/Integration_"+ int + "_output/" + intdate + "_"+ callsets + "_" + int + "/ " +
...
for i in range(7):  
	...
	out.write("dx run -y GIAB:/Workflow/nist-integration-" + int + " " +
		...
		"-ichrom=" + str(chr) + " " + "-iprefix="+ HG + "_GIAB_highconf_CG-IllFB-IllGATKHC-Ion-10X_" + str(chr) + "_" + int + " " + "--destination=/" + HG + "/Integration_"+ int + "_output/" + intdate + "_CG-IllFB-IllGATKHC-Ion-10X_" + int + "/ " +
