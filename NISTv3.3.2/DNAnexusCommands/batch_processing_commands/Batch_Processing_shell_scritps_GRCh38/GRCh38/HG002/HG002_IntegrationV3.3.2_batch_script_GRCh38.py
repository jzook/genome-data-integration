...
out = open("170103_nist-integration-v3.3.2-anyref_hg2_b38.sh", "w") 

#Set all of these values as appropriate for current integration
int="v.3.3.2"                              #Integration version
HG="HG002" 								#genome number
intdate= "170103" 						#date integration is being run, yymmdd
CG="GS000037263" 						#identifier for Complete Genomics dataset
ion="20141120.NA24385" 					#identifier for Ion dataset
...
cstable= "170103_HG002_Callset_tables_GC_Ilmn_SOLID_10X_Ion_for_GRCh38_v3.3.2/"
