...
for i in {1..22}; do
    ...
    dx run -y GIAB:/Workflow/nist-integration-v3.3 \
        ...
        -ivcfs=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_Hiseq100X/Sentieon_output/HG006_${i}_GRCh37_novoalign_Hiseq100X_sentieonHC.vcf.gz \
        -ivcfs=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_6Kb_MatePair/FreeBayes_output/HG006_${i}_GRCh37_novoalign_6Kb_MatePair_FB.vcf.gz \
        -ivcfs=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_6Kb_MatePair/Sentieon_output/HG006_${i}_GRCh37_novoalign_6Kb_MatePair_sentieonHC.vcf.gz \
        -ibeds=GIAB:/HG006/GRCh37/10XGenomics/Integration_prepare_10X_output_v3.3/HG006_${i}_GRCh37_10X_sentieonHCbyhaplo_callable.bed \
        -ibeds=GIAB:/HG006/GRCh37/Complete_Genomics/Integration_prepare_cg_output/vcfBeta-GS000037476-ASM_callable_${i}.bed \
        -ibeds=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_Hiseq100X/Integration_prepare_sentieon_v.3.3.2/HG006_${i}_GRCh37_novoalign_Hiseq100X_sentieonHC_gvcf_callable.bed \
        -ibeds=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_Hiseq100X/CallableLoci_output/HG006_${i}_GRCh37_novoalign_Hiseq100X_callableloci.bed \
        -ibeds=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_6Kb_MatePair/Integration_prepare_sentieon_v.3.3.2/HG006_${i}_GRCh37_novoalign_6Kb_MatePair_sentieonHC_gvcf_callable.bed \
        -ibeds=GIAB:/HG006/GRCh37/Illumina/Illumina_GRCh37_6Kb_MatePair/CallableLoci_output/HG006_${i}_GRCh37_novoalign_6Kb_MatePair_callableloci.bed \
        ...
        -icallsettable=callset_tables/180730_HG006_callset_tables/HG006_Datasets_CG-Illfb-IllsentieonHC-Ion-10XsentieonHC-SOLIDgatkHC_GRCh37_${i}.txt \
