#!/usr/bin/bash
## Running Integration Pipeline GRCh38 HG006
...
for i in {1..22}; do
    ...
    dx run -y GIAB:/Workflow/nist-integration-v3.3.2-anyref \
        ...
        -ibeds=GIAB:/HG006/GRCh38/Illumina/Illumina_GRCh38_6Kb_MatePair/CallableLoci_output/HG006_${i}_GRCh38_novoalign_6Kb_MatePair_callableloci.bed \
        ...
        -icallsettable=callset_tables/180730_HG006_callset_tables/HG006_Datasets_CG-Illfb-IllsentieonHC-Ion-10XsentieonHC-SOLIDgatkHC_GRCh38_${i}.txt \
        ...
        -ichrom=${i} \
        -iprefix=HG006_GIAB_GRCh38_highconf_CG-IllFB-IllSNT-10X_${i}_v3.3 \
        --destination=GIAB:/HG006/GRCh38/Integration_v3.3_output/180723_CG-IllFB-IllSNT-10X_v3.3/ \
