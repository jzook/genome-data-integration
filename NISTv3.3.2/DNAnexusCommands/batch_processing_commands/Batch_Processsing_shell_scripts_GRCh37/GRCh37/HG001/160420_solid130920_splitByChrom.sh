...
#dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_1to5 -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 
#dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_6to12 -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 
#dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_13toMT -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 
