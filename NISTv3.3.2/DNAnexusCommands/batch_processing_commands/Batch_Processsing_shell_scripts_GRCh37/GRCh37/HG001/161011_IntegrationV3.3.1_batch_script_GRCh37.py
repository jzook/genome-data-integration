...
cstable= "-icallsettable=/callset_tables/161011_HG001_Callset_tables_CG_Ilmn_Ion_10X_Solid5500_for_GRCh37_v3.3.1/NA12878_RM8398_Datasets_CG_Illumina_Ion_Solid5500_10X_Files_GRCh37_"
...
ifiltbed1= "-ifiltbeds=/HG001/GRCh37/PacBio_MetaSV_svclassify_mergedSVs.bed"
...
for i in range(15):  
	...
	out.write("dx run -y GIAB:/Workflow/nist-integration-v3.3.1-anyref "+
		...
		"-ivcfs=/"+HG+"/GRCh37/Illumina/GATKHC_output/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn150bp300X_GATKHC.vcf.gz " +
		"-ivcfs=/"+HG+"/GRCh37/Illumina/FreeBayes_output/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn150bp300X_FB.vcf.gz " + 
		"-ivcfs=/"+HG+"/GRCh37/Ion_Torrent/Integration_prepare_ion_output/TSVC_variants_defaultlowsetting_"+ str(chr) + ".vcf.gz " +
		...
		"-ivcfs=/"+HG+"/GRCh37/SOLID/130920_PE50x50bp/GATKHC_output/"+ HG + "_" + str(chr) + "_hg19_solid5500_PE50x50bp_GATKHC.vcf.gz "+
		"-ivcfs=/"+HG+"/GRCh37/SOLID/131114_SE75bp/GATKHC_output/"+ HG + "_" + str(chr) + "_hg19_solid5500_SE75bp_GATKHC.vcf.gz "+


		"-ibeds=/"+HG+"/GRCh37/Complete_Genomics/Integration_prepare_cg_output/vcfBeta-"+CG+"-ASM_callable_"+str(chr)+".bed " +
		"-ibeds=/"+HG+"/GRCh37/Illumina/Integration_prepare_GATKHC_v.3.3.1/" + HG + "_" + str(chr) +"_hs37d5_novoalign_Ilmn150bp300X_GATKHC_gvcf_callable.bed " +
		"-ibeds=/"+HG+"/GRCh37/Illumina/CallableLoci_output/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn150bp300X_callableloci.bed " +
		"-ibeds=/"+HG+"/GRCh37/Ion_Torrent/Integration_prepare_ion_output/TSVC_variants_defaultlowsetting_callable_"+ str(chr) + ".bed " +
		"-ibeds=/"+HG+"/GRCh37/10XGenomics/Integration_prepare_10X_output/"+HG+"_"+str(chr)+"_10X_GATKHCbyhaplo_callable.bed " +
		#"-ibeds=/"+HG+"/GRCh37/Illumina/Illumina_hs37d5_250x250/Integration_prepare_GATKHC_"+int+"/"+HG+"_"+str(chr)+"_hs37d5_novoalign_Ilmn250x250_GATKHC_gvcf_callable.bed " +
