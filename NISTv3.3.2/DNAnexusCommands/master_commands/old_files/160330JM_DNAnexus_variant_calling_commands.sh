...
dx run GIAB:/Workflow/samtools_splitchrom_addrg_1to6 -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 
dx run GIAB:/Workflow/samtools_splitchrom_addrg_7to16 -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 
dx run GIAB:/Workflow/samtools_splitchrom_addrg_17toMT -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 
...
#Form high-confidence vcf and bed by integrating all individual vcf and bed files
dx run GIAB:/Workflow/nist-integration-v3.1 -ivcfs=/NA12878/Complete_Genomics/vcfBeta-GS000025639-ASM_20.vcf.gz -ivcfs=/NA12878/Illumina/GATKHC_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_GATKHC.vcf.gz -ivcfs=/NA12878/Illumina/FreeBayes_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_FB.vcf.gz  -ivcfs=/NA12878/SOLID/SOLID_20_RG.sorted.deduplicated.reorder.realigned.geno.vcf.gz -ivcfs=/NA12878/Ion_Torrent/TSVC_variants_defaultlowsetting_20.vcf.gz -ibeds=/NA12878/Complete_Genomics/vcfBeta-GS000025639-ASM_notcallable_20.bed -ibeds=/NA12878/Illumina/CallableLoci_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_callableloci.bed -ibeds=/Workflow/Chromosome_bed_files/20.bed -ibeds=/NA12878/Ion_Torrent/TSVC_variants_defaultlowsetting_notcallable_20.bed -iannotations=/NA12878/GATK_Annotations.txt -iannotations=/NA12878/Freebayes_Annotations.txt -iannotations=/NA12878/CG_Annotations.txt -iannotations=/NA12878/Ion_Annotations.txt -icallsettable=/NA12878/NA12878_RM8398_Datasets_Files.txt -isvbed=/NA12878/dbvar_NA12878_CNVs_merged_all_sort.bed -ichrom=20 -iprefix=NA12878_GIAB_highconf_v3.1 --destination=/NA12878/
