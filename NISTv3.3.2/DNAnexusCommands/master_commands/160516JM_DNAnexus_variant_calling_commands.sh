...
dx run GIAB:/Workflow/samtools_splitchrom_addrg_1to5 -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 --destination=/NA12878/Illumina/
dx run GIAB:/Workflow/samtools_splitchrom_addrg_6to12 -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 --destination=/NA12878/Illumina/
dx run GIAB:/Workflow/samtools_splitchrom_addrg_13toMT -isorted_bam=HG001.hs37d5.300x_novoalign.bam -iindex_bai=HG001.hs37d5.300x_novoalign.bai -irgid=1 -irglb=all -irgpl=illumina -irgpu=all -irgsm=NA12878 --destination=/NA12878/Illumina/
...
#output path, --destination
dx run GIAB:/Workflow/GATK_V3.5/gatk-genotype-gvcfs-v3.5 -ivcfs=HG001_20_hs37d5_novoalign_Ilmn150bp300X_GATKHC_gvcf.vcf.gz -ivcfs=HG001_20_hs37d5_novoalign_Ilmn150bp300X_GATKHC_gvcf.vcf.gz.tbi -iprefix=HG001_20_hs37d5_novoalign_Ilmn150bp300X_GATKHC --destination=/NA12878/Illumina/GATKHC_output/
...
#output path, --destination
dx run GIAB:/Workflow/GATK_V3.5/gatk-callableloci-v3.5 -iinput_bam=HG001.hs37d5.300x_novoalign.20.bam -iinput_bai=HG001.hs37d5.300x_novoalign.20.bai -ioutput_prefix=HG001_hs37d5_novoalign_Ilmn150bp300X_callableloci -iextra_options="-L 20 -minDepth 20 -mmq 20 -maxDepth 560" --destination=/NA12878/Illumina/CallableLoci_output/
...
#THE FOLLOWING COMMANDS ARE RUN WITHIN DNAnexus

#Split merged bam by chromosome, removes MT
#sorted bam file to be split, --isorted
#bam index file, -iindex
#Read group ID (rgid): 1
#Read group LB (rglb): all
...
dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_reord_1to5 -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 --destination=/NA12878/SOLID/130920_PE50x50bp/
#chromosomes 6 through 12
dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_reord_6to12 -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 --destination=/NA12878/SOLID/130920_PE50x50bp/
#chromosomes 13 to MT
dx run -y GIAB:/Workflow/samtools_splitchrom_addrg_reord_13toMT -isorted_bam=HG001_hg19_solid5500_PE50x50bp.bam -iindex_bai=HG001_hg19_solid5500_PE50x50bp.bam.bai -irgid=1 -irglb=all -irgpl=solid -irgpu=all -irgsm=NA12878 --destination=/NA12878/SOLID/130920_PE50x50bp/
...
#output path, --destination
dx run -y GIAB:/Workflow/GATK_V3.5/gatk-genotype-gvcfs-v3.5 -ivcfs=HG001_20_hg19_solid5500_PE50x50bp_GATKHC_gvcf.vcf.gz -ivcfs=HG001_20_hg19_solid5500_PE50x50bp_GATKHC_gvcf.vcf.gz.tbi -iprefix=HG001_20_hg19_solid5500_PE50x50bp_GATKHC --destination=/NA12878/SOLID/130920_PE50x50bp/GATKHC_output/
...
#output path, --destination
dx run GIAB:/Workflow/GATK_V3.5/gatk-callableloci-v3.5 -iinput_bam=GIAB:/NA12878/Ion_Torrent/IonXpress_020_rawlib.b37.bam -iinput_bai=GIAB:/NA12878/Ion_Torrent/IonXpress_020_rawlib.b37.bam.bai -ioutput_prefix=HG001_20_hs37d5_IonExome_callableloci -iextra_options="-L 20 -minDepth 20 -mmq 20" --destination=/NA12878/Ion_Torrent/callableLoci_output/
...
#split by chromosome, -ichrom
#location for output files, -destination
dx run -y GIAB:/Workflow/nist-integration-v3.2 -ivcfs=/NA12878/Complete_Genomics/Integration_prepare_cg_output/vcfBeta-GS000025639-ASM_20.vcf.gz -ivcfs=/NA12878/Illumina/GATKHC_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_GATKHC.vcf.gz -ivcfs=/NA12878/Illumina/FreeBayes_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_FB.vcf.gz -ivcfs=/NA12878/Ion_Torrent/Integration_prepare_ion_output/TSVC_variants_defaultlowsetting_20.vcf.gz -ivcfs=/NA12878/SOLID/130920_PE50x50bp/GATKHC_output/HG001_20_hg19_solid5500_PE50x50bp_GATKHC.vcf.gz -ivcfs=/NA12878/SOLID/131114_SE75bp/GATKHC_output/HG001_20_hg19_solid5500_SE75bp_GATKHC.vcf.gz -ibeds=/NA12878/Complete_Genomics/Integration_prepare_cg_output/vcfBeta-GS000025639-ASM_notcallable_20.bed -ibeds=/NA12878/Illumina/CallableLoci_output/HG001_20_hs37d5_novoalign_Ilmn150bp300X_callableloci.bed -ibeds=/NA12878/Ion_Torrent/Integration_prepare_ion_output/TSVC_variants_defaultlowsetting_notcallable_20.bed -ibeds=/Workflow/Chromosome_bed_files/20.bed -iannotations=/NA12878/Annotation_files/GATK_Annotations_160509.txt -iannotations=/NA12878/Annotation_files/Freebayes_Annotations_160408.txt -iannotations=/NA12878/Annotation_files/CG_Annotations_160408.txt -iannotations=/NA12878/Annotation_files/Ion_Annotations_160408.txt -icallsettable=/NA12878/callset_tables/160510_Callset_tables_CG_IllGATK_IllFB_Ion_solidPE_solidSE/NA12878_RM8398_Datasets_CG_Illumina_Ion_Solid5500_Files_20.txt -isvbed=/NA12878/PacBio_MetaSV_svclassify_mergedSVs.bed -ichrom=20 -iprefix=NA12878_GIAB_highconf_CG-IllFB-IllGATKHC-Ion-Solid_20_v3.2a --destination=/NA12878/Integration_v3.2_output/160510_Ill_CG_Ion_Solid_v3.2a/
