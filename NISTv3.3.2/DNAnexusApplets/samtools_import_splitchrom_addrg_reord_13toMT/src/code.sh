...
#
samtools view -buh input.bam 13 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam13.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam13.bam bam13.bai &
ls -l
samtools view -buh input.bam 14 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam14.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam14.bam bam14.bai &
samtools view -buh input.bam 15 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam15.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam15.bam bam15.bai &
samtools view -buh input.bam 16 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam16.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam16.bam bam16.bai &
samtools view -buh input.bam 17 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam17.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam17.bam bam17.bai &
samtools view -buh input.bam 18 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam18.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam18.bam bam18.bai &
samtools view -buh input.bam 19 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam19.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam19.bam bam19.bai &
samtools view -buh input.bam 20 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam20.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam20.bam bam20.bai &
samtools view -buh input.bam 21 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam21.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam21.bam bam21.bai &
samtools view -buh input.bam 22 | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bam22.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bam22.bam bam22.bai &
samtools view -buh input.bam X | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bamX.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
samtools index bamX.bam bamX.bai &
samtools view -buh input.bam Y | $java -jar /ReorderSam.jar I=/dev/stdin O=/dev/stdout S=true R=/human_g1k_v37_1to22XYonly.fasta | $java -jar /AddOrReplaceReadGroups.jar I=/dev/stdin O=bamY.bam RGID=$rgid RGLB=$rglb RGPL=$rgpl RGPU=$rgpu RGSM=$rgsm $opts
