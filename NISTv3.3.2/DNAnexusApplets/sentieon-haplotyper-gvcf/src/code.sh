...
#
$release_dir/bin/sentieon driver $extra_driver_options -r $genome_file  -t $sentieon_procs -i "$sorted_bam_path" --algo Haplotyper --emit_mode gvcf $extra_algo_options $dbsnp output.gvcf.gz
