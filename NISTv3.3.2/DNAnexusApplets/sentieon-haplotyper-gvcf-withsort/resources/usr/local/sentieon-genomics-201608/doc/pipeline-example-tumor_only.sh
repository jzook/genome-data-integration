...
panel_of_normal_TNsnv="/home/pipeline/panel_of_normal.vcf.gz"
...
panel_of_normal_TNhaplotyper="/home/pipeline/panel_of_normal.vcf.gz"
cosmic_db="/home/pipeline/comsic_db.vcf.gz" 
...
workdir="$HOME/testcaseTN_pon" #Determine where the output files will be stored
