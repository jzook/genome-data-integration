...
workdir="$PWD/test_RNA" #Determine where the output files will be stored
...
# ******************************************
$release_dir/bin/sentieon driver -r $fasta -t $nt -i deduped.bam --algo RNASplitReadsAtJunction --reassign_mapq 255:60 splitted.bam

# ******************************************
# 5. Indel realigner
# ******************************************
$release_dir/bin/sentieon driver -r $fasta  -t $nt -i splitted.bam --algo Realigner -k $known_Mills_indels -k $known_1000G_indels realigned.bam
