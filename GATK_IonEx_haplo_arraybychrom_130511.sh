...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R $BASE/references/hs37d5.fa -I /scratch/justin.zook/NA12878/IonEx/IonExome.bam -L $LINE --minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 100 -o /scratch/justin.zook/NA12878/IonEx/IonExome_haplo2.5_"$LINE1".vcf
