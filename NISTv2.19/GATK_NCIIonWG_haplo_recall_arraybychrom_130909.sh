...
#$ -l h_rt=90:00:00
#$ -l h_vmem=6G
#$ -N GATK_NCIIonWG_haplotrigger2.7
#$ -pe thread 1
#$ -t 2-21
...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R /scratch/justin.zook/references/human_g1k_v37.fasta  \
	...
	--minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 200 -o /scratch/justin.zook/NA12878/NCIIonWG/NCIIonWG_haplotrigger2.7_130909_"$LINE1".vcf
