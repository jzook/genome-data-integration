...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R /scratch/justin.zook/references/human_g1k_v37.fasta -I /scratch/justin.zook/NA12878/XIllWG/LP6005036-DNA_A01_b37_RG.sorted.bam $LINE --minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 200 -o /scratch/justin.zook/NA12878/XIllWG/LP6005036-DNA_A01_haplo2.6_"$LINE1".vcf
