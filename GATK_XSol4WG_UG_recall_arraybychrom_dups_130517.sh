...
java -jar -Xmx4g  ~/bcbio.variation-0.0.5-standalone.jar -R /scratch/justin.zook/references/human_g1k_v37.fasta -T UnifiedGenotyper -glm BOTH -I /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_part1.bam -I /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_part2.bam \
	$LINE -alleles:consensus /scratch/justin.zook/NA12878/UGHaploCortexCombined_snpindel_130517_dups_"$LINE1".vcf -U LENIENT_VCF_PROCESSING -gt_mode GENOTYPE_GIVEN_ALLELES -out_mode EMIT_ALL_SITES -stand_call_conf 0.0 -mbq 10 \
	...
	-o /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_UGrecall130517_dups_"$LINE1".vcf -nt 1
