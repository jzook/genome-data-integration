...
#$ -l h_rt=20:00:00
#$ -l h_vmem=5G
#$ -N GATK_IllPCRFree_UGrecall_dups
#$ -pe thread 1
#$ -t 17
...
java -jar -Xmx4g  ~/bcbio.variation-0.0.5-standalone.jar -R /scratch/justin.zook/references/human_g1k_v37.fasta -T UnifiedGenotyper -glm BOTH -I /scratch/justin.zook/NA12878/IllPCRFree/ERR09157x_dedup_realign.sorted.bam \
	...
	-o /scratch/justin.zook/NA12878/IllPCRFree/ERR09157x_dedup_realign_UGrecall130517_dups_"$LINE1".vcf -nt 1
