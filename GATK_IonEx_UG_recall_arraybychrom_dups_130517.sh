...
java -jar -Xmx4g  ~/bcbio.variation-0.0.5-standalone.jar -R /scratch/justin.zook/references/human_g1k_v37.fasta -T UnifiedGenotyper -glm BOTH -I /scratch/justin.zook/NA12878/IonEx/IonExome.bam \
	...
	-o /scratch/justin.zook/NA12878/IonEx/IonExome_UGrecall130517_dups_"$LINE1".vcf -nt 1
