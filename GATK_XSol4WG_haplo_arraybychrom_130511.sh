...
java -jar -Xmx4g $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R /scratch/justin.zook/references/human_g1k_v37.fasta -I /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_part1.bam -I /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_part2.bam $LINE --minPruning 3 -stand_call_conf 2 -stand_emit_conf 2 -dcov 100 -o /scratch/justin.zook/NA12878/XSol4WG/NIST_XPrizeSOLiD_Lifescope_haplo2.5_"$LINE1".vcf
