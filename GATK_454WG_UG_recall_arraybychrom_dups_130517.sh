...
java -jar -Xmx4g  ~/bcbio.variation-0.0.5-standalone.jar -R /scratch/justin.zook/references/human_g1k_v37.fasta -T UnifiedGenotyper -glm BOTH -I /scratch/justin.zook/NA12878/454WG/NA12878.all.WGS.LS454.ssaha2.CEU.sorted.bam \
	...
	-o /scratch/justin.zook/NA12878/454WG/NA12878.all.WGS.LS454.ssaha2.CEU_UGrecall130517_dups_"$LINE1".vcf -nt 1
